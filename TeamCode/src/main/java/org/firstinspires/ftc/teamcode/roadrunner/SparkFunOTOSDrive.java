...
//        log.info("OTOS pose: " + pose);
    ...
    public static class Params {
        ...
        //public SparkFunOTOS.Pose2D offset = new SparkFunOTOS.Pose2D(-4.1211, -0.024, Math.toRadians(-90.4453));
        //public SparkFunOTOS.Pose2D offset = new SparkFunOTOS.Pose2D(0.0601, 4.2352, Math.toRadians(-90.4453));
        public SparkFunOTOS.Pose2D offset = new SparkFunOTOS.Pose2D(4.1211, 0.024, Math.toRadians(-90.4453));
        ...
        public double angularScalar = 0.9981;
    }
